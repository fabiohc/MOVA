...
class _EditarEventoState extends State<EditarEvento>
  ...
  Widget build(BuildContext context) {
    final AgendaModel registroEditado =
        ModalRoute.of(context).settings.arguments;
    if (pessoaSelecionada != null)
      pessoaController.pessoaModel = pessoaSelecionada;

    registroEditado != null
        ? agendaController.agendaModel = registroEditado
        : agendaController.agendaModel = new AgendaModel();

    if (pessoaSelecionada.pessoaIdGlobal == null)
              ...
              children: <Widget>[
                IconButton(
                  onPressed: () => Navigator.of(context)
                      .popAndPushNamed(RotasNavegacao.AGENDA),
                                  ...
                                  child: Observer(builder: (_) {
                                    return TextFormField(
                                      ...
                                      controller: new TextEditingController(
                                          text: agendaController
                                              .agendaModel.agenDataInicio),
                                      autofocus: false,
                                      keyboardType:
                                  ...
                                  child: ValueListenableBuilder(
                                      ...
                                      builder: (context, value, child) {
                                        return SwitchListTile(
                                          ...
                                          dense: true,
                                          value: agendaController
                                              .agendaModel.agenDiaTodo,
  ...
  Flushbar flushbarExcluir(
      String titleQuestione, String menssagemConfirmeAcao, AgendaModel evento) {
    Flushbar flush;
              ...
              onPressed: () {
                ...
                return flush = Flushbar<bool>(
                  ...
                  backgroundGradient: LinearGradient(colors: [
                    ...
                    agendaController.deleteRegistro(evento);
              ...
              onPressed: () {
                ...
                return flush = Flushbar<bool>(
                  ...
                  backgroundGradient: LinearGradient(colors: [
                    ...
                    agendaController.updateEvento(evento);
