  ...
  void initState() {
    ...
    receitaController.obtentaListaReceitas().then((list) {
      setState(() {
        ...
        if (listaReceitasMesAtual != null) carregamentoCompleto = false;
      });
    });
              ...
              onPressed: () {
                ...
                return flush = Flushbar<bool>(
                  ...
                  backgroundGradient: LinearGradient(colors: [
                    ...
                    await receitaController.deleteRegistro(receita);
                    receitaController.obtentaListaReceitas().then((list) {
                      setState(() {
                        listaReceitas = list;
